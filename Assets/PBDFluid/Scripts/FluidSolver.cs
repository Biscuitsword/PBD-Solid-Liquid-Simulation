...
namespace PBDFluid
{
    ...
    public class FluidSolver : IDisposable
    {
        ...
        public SolidBody solid_Body { get; private set; }
        ...
        public FluidSolver(FluidBody body, FluidBoundary boundary, SolidBody m_solid)
        {
            SolverIterations = 2;
            ...
            Body = body;
            Boundary = boundary;
            solid_Body = m_solid;   // 固体作为边界的一种

            float cellSize = Body.ParticleRadius * 4.0f;
            int total = Body.NumParticles + Boundary.NumParticles;
            Hash = new GridHash(Boundary.Bounds, total, cellSize, solid_Body.NumParticles);
        ...
        public void StepPhysics(float dt, SolidBody extra = null)
        {
            solid_Body = extra;
            if (dt <= 0.0) return;
            ...
            m_shader.SetInt("ExtraParticles", solid_Body.NumParticles);
            ...
            for (int i = 0; i < SolverIterations; i++)
            {
                ...
                Hash.Process(Body.Predicted[READ], Boundary.Positions, solid_Body.Positions);
        ...
        public void ConstrainPositions()
        {
            ...
            m_shader.SetBuffer(computeKernel, "Extra", solid_Body.Positions);
            ...
            m_shader.SetBuffer(solveKernel, "Extra", solid_Body.Positions);
